...
object AuthActionUtil {
     ...
     * 旧版、新版操作id映射
     */
    private val ActionMapping = mapOf<String, List<String>>(
    ...
    fun getRbacAction(codeCCAuthActionName: String): List<String> {
        return ActionMapping[codeCCAuthActionName] ?: listOf()
    }

    /**
     * 新版pipeline操作id映射
     */
    private val pipelineActionMapping = mapOf<String, String>(
