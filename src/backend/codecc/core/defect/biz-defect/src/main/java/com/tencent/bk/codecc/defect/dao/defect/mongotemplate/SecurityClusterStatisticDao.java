...
@Repository
public class SecurityClusterStatisticDao {
    @Autowired
    private MongoTemplate defectMongoTemplate;

    public List<SecurityClusterStatisticEntity> findListByTaskIdAndBuildId(List<MetricsEntity> metricsEntityList) {
        ...
        return defectMongoTemplate.find(query, SecurityClusterStatisticEntity.class);
    }
}
