...
public class BuildToolBuildInfoResourceImpl implements BuildToolBuildInfoResource
{
    ...
    @Override
    public Result<Boolean> setToolBuildStackFullScan(Long taskId, ToolBuildStackReqVO toolBuildStackReqVO)
    {
        return new Result<>(toolBuildInfoService.setToolBuildStackFullScan(taskId, toolBuildStackReqVO));
    }
}
