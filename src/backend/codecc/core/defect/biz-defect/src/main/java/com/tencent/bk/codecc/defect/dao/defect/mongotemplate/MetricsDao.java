...
public class MetricsDao {
    ...
    public MetricsEntity findLastByTaskId(Long taskId) {
        ...
        query.with(sort);
        query.limit(1);
        List<MetricsEntity> metricsEntityList = defectMongoTemplate.find(query, MetricsEntity.class);
    ...
    public List<MetricsEntity> findLastByTaskIdIn(List<Long> taskIds) {
        ...
        AggregationResults<MetricsEntity> queryResult = defectMongoTemplate.aggregate(agg, "t_metrics", MetricsEntity.class);
    ...
    public boolean upsert(MetricsEntity metricsEntity) {
        ...
        update.set("task_id", metricsEntity.getTaskId())
                ...
                .set("average_normal_standard_thousand_defect", metricsEntity.getAverageNormalStandardThousandDefect())
                .set("code_style_serious_defect_count", metricsEntity.getCodeStyleSeriousDefectCount())
                .set("average_serious_standard_thousand_defect",
                        metricsEntity.getAverageSeriousStandardThousandDefect())
                .set("code_defect_normal_defect_count", metricsEntity.getCodeDefectNormalDefectCount())
                .set("average_normal_defect_thousand_defect", metricsEntity.getAverageNormalDefectThousandDefect())
                .set("code_defect_serious_defect_count", metricsEntity.getCodeDefectSeriousDefectCount())
                .set("average_serious_defect_thousand_defect", metricsEntity.getAverageSeriousDefectThousandDefect())
