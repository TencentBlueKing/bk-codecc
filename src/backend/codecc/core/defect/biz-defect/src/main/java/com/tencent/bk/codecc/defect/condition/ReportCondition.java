...
public class ReportCondition implements Condition {

    private Logger logger = LoggerFactory.getLogger(ReportCondition.class);
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        return springAppName.contains("report");
    }
}
