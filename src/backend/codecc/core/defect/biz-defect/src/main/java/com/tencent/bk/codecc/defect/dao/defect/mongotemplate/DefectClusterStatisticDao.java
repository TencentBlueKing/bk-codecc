...
@Repository
public class DefectClusterStatisticDao {
    @Autowired
    private MongoTemplate defectMongoTemplate;

    public List<DefectClusterStatisticEntity> findListByTaskIdAndBuildId(List<MetricsEntity> metricsEntityList) {
        ...
        return defectMongoTemplate.find(query, DefectClusterStatisticEntity.class);
    }
}
