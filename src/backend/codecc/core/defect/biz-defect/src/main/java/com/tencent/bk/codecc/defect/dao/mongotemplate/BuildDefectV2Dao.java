...
public class BuildDefectV2Dao {
    ...
    private static final int BATCH_SIZE = 5_0000;
    ...
    public void save(List<BuildDefectV2Entity> buildDefectEntityList) {
        ...
        if (buildDefectEntityList.size() > BATCH_SIZE) {
            List<List<BuildDefectV2Entity>> partitionList = Lists.partition(buildDefectEntityList, BATCH_SIZE);
    ...
    private void doBatchInsert(List<BuildDefectV2Entity> buildDefectEntityList) {
        mongoTemplate.bulkOps(BulkOperations.BulkMode.UNORDERED, BuildDefectV2Entity.class)
                .insert(buildDefectEntityList)
                .execute();
    }

    private void doBatchUpsert(List<BuildDefectV2Entity> buildDefectEntityList) {
        BulkOperations ops = mongoTemplate.bulkOps(BulkOperations.BulkMode.UNORDERED, BuildDefectV2Entity.class);
