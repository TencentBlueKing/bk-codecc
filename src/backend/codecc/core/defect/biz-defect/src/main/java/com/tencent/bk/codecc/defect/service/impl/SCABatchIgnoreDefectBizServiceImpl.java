...
@Slf4j
@Service("SCABatchIgnoreDefectBizService")
public class SCABatchIgnoreDefectBizServiceImpl extends AbstractSCABatchDefectProcessBizService {
    ...
    protected void doBiz(List defectList, BatchDefectProcessReqVO batchDefectProcessReqVO) {
        ...
        service.batchIgnoreDefect(defectList, batchDefectProcessReqVO);
    ...
    protected void doBizByPage(List defectList, BatchDefectProcessReqVO batchDefectProcessReqVO) {
        ...
        service.batchIgnoreDefectByPage(defectList, batchDefectProcessReqVO);
    }
    ...
    protected Pair<ComConstants.BusinessType, ComConstants.ToolType> getBusinessTypeToolTypePair() {
        return Pair.of(ComConstants.BusinessType.IGNORE_DEFECT, ComConstants.ToolType.SCA);
    }
}
