...
public class ToolBuildStackDao
{
    ...
    public void upsert(ToolBuildStackEntity toolBuildStackEntity)
    {
        ...
        defectMongoTemplate.upsert(query, update, ToolBuildStackEntity.class);
    }

    public void batchUpsert(Collection<ToolBuildStackEntity> toolBuildStackEntitys)
    {
        BulkOperations ops = defectMongoTemplate.bulkOps(BulkOperations.BulkMode.UNORDERED, ToolBuildStackEntity.class);
