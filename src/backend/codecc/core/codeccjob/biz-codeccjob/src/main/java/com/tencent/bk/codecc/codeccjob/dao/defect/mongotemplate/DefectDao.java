...
public class DefectDao {
    ...
    public List<CheckerStatisticEntity> findStatByTaskIdAndToolChecker(Collection<Long> taskIdSet, String toolName,
        ...
        return defectMongoTemplate.aggregate(agg, "t_defect", CheckerStatisticEntity.class).getMappedResults();
    }
    ...
    public void batchUpdateDefectStatusExcludeBit(long taskId, List<CommonDefectEntity> defectList) {
        if (CollectionUtils.isNotEmpty(defectList)) {
            BulkOperations ops = defectMongoTemplate.bulkOps(BulkOperations.BulkMode.UNORDERED, CommonDefectEntity.class);
