...
export default {
  ...
  actions: {
    count({ commit, rootState }, data) {
      return http
        .post('/defect/api/user/checkerSet/count', data)
        .then((res) => {
          const data = res.data || {};
    ...
    list({ commit, rootState }, params) {
      return http
        .post('/defect/api/user/checkerSet/list', params)
        .then((res) => {
          const data = res.data || {};
          return data;
        })
    ...
    otherList({ commit, rootState }, params) {
      return http
        .post('/defect/api/user/checkerSet/otherList', params)
        .then((res) => {
          const data = res.data || {};
          return data;
        })
    ...
    listForDefect({ commit, rootState }, params) {
      return http
        .post('/defect/api/user/checkerSet/queryTaskCheckerSets', params)
        .then((res) => {
          const data = res.data || {};
          return data;
        })
    ...
    params({ commit, rootState }) {
      return http
        .get('/defect/api/user/checkerSet/params')
        .then((res) => {
          const data = res.data || {};
    ...
    create({ commit, rootState }, params) {
      return http
        .post('/defect/api/user/checkerSet', params)
        .then((res) => {
          const data = res || {};
          return data;
        })
    ...
    edit({ commit, rootState }, params) {
      ...
      return http
        .put(
          `/defect/api/user/checkerSet/${params.checkersetId}/baseInfo`,
          payload,
        )
        .then((res) => {
          const data = res || {};
    ...
    detail({ commit, rootState }, params) {
      return http
        .get(`/defect/api/user/checkerSet/${params.checkersetId}/versions/${params.version}/detail`)
        .then((res) => {
          const data = res.data || {};
          return data;
        })
    ...
    save({ commit, rootState }, params) {
      ...
      return http
        .put(
          `/defect/api/user/checkerSet/checkerSets/${params.checkersetId}/checkers`,
          payload,
        )
        .then((res) => {
          const data = res || {};
    ...
    batchsave({ commit, rootState }, params) {
      return http
        .post('/defect/api/user/checkerSet/checkers/all', params)
        .then((res) => {
          const data = res || {};
          return data;
        })
    ...
    categoryList({ commit, rootState }, params) {
      return http
        .get('/defect/api/user/checkerSet/categoryList')
        .then((res) => {
          const data = res.data || {};
          return data;
        })
    ...
    manage({ commit, rootState }, params) {
      ...
      return http
        .post(`/defect/api/user/checkerSet/${checkerSetId}/management`, params)
        .then((res) => {
          const data = res || {};
          return data;
        })
    ...
    install({ commit, rootState }, params) {
      ...
      return http
        .post(
          `/defect/api/user/checkerSet/${checkerSetId}/relationships`,
          params,
        )
        .then((res) => {
          const data = res || {};
    ...
    permission({ commit, rootState }, params) {
      return http
        .post('/defect/api/user/checkerSet/userManagementPermission', params)
        .then((res) => {
          const data = res || {};
          return data;
        })
    ...
    config({ commit, rootState }, params) {
      return http
        .post(
          `/defect/api/user/checkerSet/relationships/once?toolName=${params.toolName}`,
          params,
        )
        .then((res) => {
          const data = res || {};
