...
export default {
  ...
  actions: {
    status({ commit, state, rootState }) {
      ...
      return http.get('/task/api/user/task/status').then((res) => {
    ...
    list({ commit, state, rootState }, params) {
      ...
      return http.post(`/task/api/user/task/taskSortType/${orderType}`, params).then((res) => {
        const list = res.data || {}
        return list
      })
        .catch(e => e)
    ...
    editTaskTop({ commit, state, rootState }, params) {
      ...
      return http.put(`/task/api/user/task/top/config/taskId/${params.taskId}/topFlag/${params.topFlag}`).then(res => res)
        .catch(e => e)
    },
    requestRepolist({ commit, state, rootState }, idList) {
      ...
      return http.post('/defect/api/user/repo/list', idList).then((res) => {
        const list = res.data || {}
        return list
      })
        .catch(e => e)
    ...
    basicList({ commit, state, rootState }) {
      ...
      return http.get('/task/api/user/task/base').then((res) => {
        const list = res.data || {}
    ...
    detail({ commit, state, rootState }, config = {}) {
      ...
      return http.get('/task/api/user/task/taskInfo').then((res) => {
    ...
    basicInfo({ commit, state, rootState }, params) {
      ...
      return http.get(`/task/api/user/task/taskId/${params.taskId}`).then((res) => {
        const task = res.data || {}
        return task
      })
        .catch(e => e)
    ...
    memberInfo({ commit, state, rootState }) {
      return http.get('/task/api/user/task/memberList').then((res) => {
        const task = res.data || {}
        return task
      })
        .catch(e => e)
    ...
    updateBasicInfo({ commit, state, rootState }, params) {
      return http.put('/task/api/user/task', params).then((res) => {
        const data = res.data || {}
        return data
      })
        .catch(e => e)
    ...
    createIgnore({ commit, rootState }, data) {
      // return http.post('/task/index?invoke=create', data).then(res => {
      return http.post('/task/api/user/task/add/filter/path', data).then((res) => {
    ...
    deleteIgnore({ commit, rootState }, params) {
      return http.delete('/task/api/user/task/del/filter', params).then((res) => {
        const data = res.data || []
        return data
      })
        .catch(e => e)
    ...
    ignore({ commit, state, rootState }, taskId) {
      return http.get(`/task/api/user/task/filter/path/${taskId}`).then((res) => {
    ...
    ignoreTree({ commit, state, rootState }) {
      return http.get('/task/api/user/task/filter/path/tree').then((res) => {
    ...
    trigger({ commit, rootState }, data) {
      return http.post(`/task/api/user/task/taskId/${data.taskId}/scanConfiguration`, data).then((res) => {
        const data = res.data || {}
        return data
      })
    },
    getRepoList(store, params = {}) {
      ...
      return http.get(`/task/api/user/tool/repos/projCode/${params.projCode}`).then((res) => {
        const data = res.data || []
        return data
      })
    },
    checkname(store, params) {
      ...
      return http.get(`/task/api/user/task/duplicate/streamName/${params.nameEn}`, { globalError: false })
    },
    addTool({ commit }, data) {
    ...
    overView({ commit }, data) {
      ...
      return http.get(`/task/api/user/task/overview/${data.taskId}?${json2Query(data)}`).then((res) => {
        const data = res.data || {}
        return data
      })
        .finally(() => {
    ...
    getCodeMessage({ commit }, store) {
      return http.get('/task/api/user/task/code/lib').then((res) => {
        const data = res.data || []
    ...
    notifyCustom({ commit }, data) {
      return http.post('/task/index?invoke=notifyCustom', data).then(res => res.data || {})
    },
    saveReport({ commit }, data) {
      return http.post('/task/api/user/task/report', data).then(res => res.data || {})
    },
    getRelateCheckerSetTools({ commit }, data) {
      return http.get('/defect/api/user/backendParams')
    },
    updateMembers({ commit }, data) {
      return http.put(`/task/api/user/task/member/taskId/${data.taskId}`, data).then(res => res.data || {})
    },
    getYml({ commit }, taskId) {
      return http.get(`/task/api/user/task/code//yml/filter/taskId/${taskId}/list`).then(res => res.data || {})
    },
    personal({ commit }, data) {
      return http.get('/defect/api/user/statistic/overview/personal').then(res => res.data || {})
    },
    taskLog({ commit }, params) {
      return http.get(`/defect/api/user/tasklog/overview?${json2Query(params)}`).then((res) => {
        const data = res.data || {}
        return data
      })
    },
    issueTypeList({ commit }, params) {
      return http.get('/task/api/user/issue/listSubSystemInfo').then(res => res.data || [])
    },
    taskIssue({ commit }, params) {
      return http.get(`/task/api/user/issue/task/${params.taskId}/getTaskIssue`).then(res => res.data || {})
    },
    updateTaskIssue({ commit }, params) {
      return http.put('/task/api/user/issue/updateTaskIssue', params).then(res => res || {})
    },
    getOpenScanAndPreProdCheckerSetMap({ commit }, params) {
      return http.get('/task/api/user/getOpenScanAndPreProdCheckerSetMap').then(res => res.data || {})
    },
  },
}
