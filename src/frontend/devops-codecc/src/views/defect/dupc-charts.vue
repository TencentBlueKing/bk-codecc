          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <a href="javascript:;" @click="handleHref({ severity: 1 })">{{
                    dupcData[0]
                  }}</a>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <a href="javascript:;" @click="handleHref({ severity: 2 })">{{
                    dupcData[1]
                  }}</a>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <a href="javascript:;" @click="handleHref({ severity: 4 })">{{
                    dupcData[2]
                  }}</a>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <a href="javascript:;" @click="handleHref()">{{
                    dupcData[3]
                  }}</a>
                </td>
              </tr>
