              ...
              <template slot-scope="props">
                <span
                  v-bk-tooltips="{
                    content:
                      $t('代码行比率') +
                      handleRate(props.row.sumCode, props.row.sumLines),
                  }"
                >
                  {{ props.row.sumCode }}
                </span>
            ...
            >
              <template slot-scope="props">
                <span
                  v-if="
                    realTool === 'SCC' &&
                    props.row.sumEfficientComment !== undefined
                  "
                  v-bk-tooltips="{
                    content:
                      $t('注释率') +
              ...
              <template slot-scope="props">
                <span
                  v-bk-tooltips="{
                    content:
                      $t('空白率') +
                      handleRate(props.row.sumBlank, props.row.sumLines),
                  }"
                >
                  {{ props.row.sumBlank }}
                </span>
...
export default {
  ...
  created() {
    if (
      ...
      this.taskDetail.enableToolList.find(
        (item) => item.toolName === 'SCC' || item.toolName === 'CLOC'
      )
    ) {
      this.init(true);
  ...
  methods: {
    async init(isInit) {
      ...
      if (res) {
        ...
        const languageInfoNew = languageInfo.filter(
