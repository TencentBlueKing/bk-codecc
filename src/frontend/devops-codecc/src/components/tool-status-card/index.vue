    ...
    <div v-if="data.lastAnalysisResult">
      <bk-container class="card-content" :col="4" v-if="data.toolName === 'CCN'">
        <bk-row class="card-num">
          ...
          <bk-col><a @click="toList()">{{data.lastAnalysisResult.defectChange === undefined ? '--' : Math.abs(data.lastAnalysisResult.defectChange)}}
            <i class="bk-icon"
          ...
          <bk-col><a @click="toList()">{{data.lastAnalysisResult.averageCCNChange === undefined ? '--' : Math.abs(data.lastAnalysisResult.averageCCNChange).toFixed(2)}}
            <i class="bk-icon"
      ...
      <bk-container class="card-content" :col="4" v-else-if="data.toolName === 'DUPC'">
        <bk-row class="card-num">
          ...
          <bk-col><a @click="toList()">{{data.lastAnalysisResult.dupRateChange === undefined ? '--' : Math.abs(data.lastAnalysisResult.dupRateChange).toFixed(2)}}<span v-if="data.lastAnalysisResult.dupRateChange !== undefined">%</span>
            <i class="bk-icon"
      ...
      <bk-container class="card-content" :col="4" v-else-if="data.toolName === 'COVERITY' || data.toolName === 'KLOCWORK' || data.toolName === 'PINPOINT'">
        <bk-row class="card-num">
          ...
          <bk-col><a @click="toList({ status: 2 })">{{data.lastAnalysisResult.fixedCount === undefined ? '--' : data.lastAnalysisResult.fixedCount}}</a></bk-col>
      ...
      <bk-container class="card-content" :col="4" v-else-if="data.toolName === 'CLOC'">
        <bk-row class="card-num">
          <bk-col><a @click="toList()" :title="data.lastAnalysisResult.totalLines">{{data.lastAnalysisResult.totalLines === undefined ? '--' : hanldeBigNum(data.lastAnalysisResult.totalLines)}}</a></bk-col>
          <bk-col>
            <a @click="toList()" :title="Math.abs(data.lastAnalysisResult.linesChange)">{{data.lastAnalysisResult.linesChange === undefined ? '--' : hanldeBigNum(Math.abs(data.lastAnalysisResult.linesChange))}}
              <i class="bk-icon"
          ...
          <bk-col>
            <a @click="toList()">{{data.lastAnalysisResult.fileNumChange === undefined ? '--' : Math.abs(data.lastAnalysisResult.fileNumChange)}}
              <i class="bk-icon"
      ...
      <bk-container class="card-content" :col="4" v-else>
        <bk-row class="card-num">
          ...
          <bk-col><a @click="toList()">{{data.lastAnalysisResult.fileChange === undefined ? '--' : Math.abs(data.lastAnalysisResult.fileChange)}}
            <i class="bk-icon"
